...
interface SeasonalEvent {
  name: string;
  label: string; // short label inside chip
  brief: string; // auto-filled brief text when clicked
  // start = first day to show the event content
  startMonth: number; // 1-12
  startDay: number;
  endMonth: number;
  endDay: number;
  showBefore: number; // days before startMonth/startDay to begin showing chip
  emoji?: string;
}
...
const EVENTS: SeasonalEvent[] = [
  {
    name: "Super Bowl",
    label: "Super Bowl",
    brief: "High-energy Super Bowl ads — cinematic, humorous, or emotionally charged",
  ...
  },
  {
    ...
    brief: "Romantic or subversive Valentine's Day ads — love, desire, connection",
  ...
  },
  {
    name: "Ramadan",
    label: "Ramadan",
    brief: "Warm, emotional storytelling for Ramadan — family, generosity, community",
  ...
  },
  {
    name: "Mother's Day",
    label: "Mother's Day",
    brief: "Heartfelt or clever Mother's Day ads — emotion, tribute, humour",
    startMonth: 5, startDay: 10,
    endMonth: 5, endDay: 11,
    showBefore: 21,
  },
  {
    name: "Cannes Lions",
    label: "Cannes Lions",
    brief: "Award-winning creative work — bold ideas, craft, cultural impact",
  ...
  },
  {
    name: "FIFA World Cup",
    label: "World Cup",
    brief: "Football / soccer ads — passion, pride, global sport storytelling",
  ...
  },
  {
    ...
    brief: "Back to school ads — youth, energy, optimism, fresh starts",
    startMonth: 8, startDay: 15,
    endMonth: 9, endDay: 10,
    showBefore: 21,
  },
  {
    name: "Halloween",
    label: "Halloween",
    brief: "Halloween ads — dark humour, horror aesthetics, candy, costumes",
  ...
  },
  {
    name: "Diwali",
    label: "Diwali",
    brief: "Diwali ads — light, family celebration, warmth, South Asian culture",
    startMonth: 11, startDay: 5,
    endMonth: 11, endDay: 6,
    showBefore: 21,
  },
  {
    name: "Black Friday",
    label: "Black Friday",
    brief: "Black Friday and retail ads — urgency, value, big moments",
  ...
  },
  {
    name: "Christmas",
    label: "Christmas",
    brief: "Cinematic Christmas ads — emotion, nostalgia, warmth, family, magic",
  ...
  },
  {
    name: "New Year",
    label: "New Year",
    brief: "New Year ads — fresh starts, ambition, celebration, reflection",
...
export function SeasonalChips({ onSelect }: Props) {
  ...
  return (
    <div className="container pb-3 flex items-center gap-2.5 flex-wrap">
      ...
      {visible.map((ev) => {
        ...
        return (
          <button
            key={ev.name}
            type="button"
            onClick={() => onSelect(ev.brief)}
            className="group relative overflow-hidden flex items-center gap-3 border hairline hover:border-primary/60 bg-background/40 hover:bg-primary/5 transition-all duration-300 px-3 py-2 text-left"
          >
            {/* Left accent bar */}
            ...
            <div className="pl-1">
              <p className="font-mono text-[8px] uppercase tracking-[0.3em] text-muted-foreground/60 leading-none mb-1">
                {isLive ? "Live now" : `in ${days}d`}
              </p>
              <p className="font-display text-[13px] font-black tracking-tight leading-none group-hover:text-primary transition-colors">
                {ev.label}
              </p>
            </div>
